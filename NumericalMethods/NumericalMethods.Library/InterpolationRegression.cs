...
namespace NumericalMethods.Library
{
    ...
    { 
        public double? ExecuteLinearInterpolation(double x0, double y0, double x1, double y1, double xp)
        {
            double? yp = null;
        ...
        public double[] ExecuteLinearRegression(double[] x, double[] y)
        {
            int n = x.Length;
            double sumX = 0;
            double sumX2 = 0;
        ...
        public double[] ExecutePowerRegression(double[] x, double[] y)
        {
            int n = x.Length;
            double sumX = 0;
            double sumX2 = 0;
